...
MATERIALS = {
    ...
    "f3": {
        ...
        "chapters": [
            {
                "title": "Lec 7: Intangible Assets (IAS 38)",
                "content": (
                    "🔹 *Intangible asset* — identifiable, non-monetary asset without physical substance, controlled by entity as a result of past events, from which future economic benefits are expected\n\n"
                    "🔹 *Identifiability:* Separable (can be sold/licensed) OR arises from contractual rights\n\n"
                    "🔹 *Recognition — Identifiable intangibles:*\n"
                    "• Criteria MET → Recorded at COST, amortised over useful life\n"
                    "• Criteria NOT met → Expensed immediately; cannot be reinstated later\n\n"
                    "🔹 *Unidentifiable intangibles:*\n"
                    "• Internally generated (brands, customer lists) → PROHIBITED from recognition\n"
                    "• Acquired in business combination → recognised as GOODWILL; tested for impairment annually\n\n"
                    "🔹 *Subsequent measurement:*\n"
                    "• Cost model: Cost − Accumulated amortisation/impairment\n"
                    "• Revaluation model: only if active market exists (homogenous goods, public prices, regular trading)\n"
                    "• Indefinite useful life → NOT amortised; tested for impairment annually\n\n"
                    "🔹 *Research vs Development:*\n"
                    "• *Research* — original investigation; always EXPENSED (economic benefits not yet probable)\n"
                    "• *Development* — application of findings; CAPITALISED only if ALL 6 PIRATE criteria met:\n"
                    "  Probable economic benefits | Intention to complete | Resources available |\n"
                    "  Ability to use/sell | Technical feasibility | Expenditure measurable reliably\n\n"
                    "🔹 *Amortisation:* starts from date of commercial production; if criteria no longer met → write off immediately\n\n"
                    "🔹 *Provisions (IAS 37):*\n"
                    "• Provision = liability of uncertain timing or amount\n"
                    "• Recognise when: present obligation from past event + probable outflow (>50%) + reliable estimate\n"
                    "• DR Expenses / CR Provision (for lawsuits, warranties, tax)\n"
                    "• DR Asset / CR Provision (for restoration/decommissioning costs)\n\n"
                    "🔹 *Contingent Liability* — possible obligation OR present obligation where payment not probable or amount not reliable\n"
                    "• NOT recognised; disclosed in notes unless remote\n\n"
                    "🔹 *Contingent Asset* — possible asset whose existence depends on uncertain future event\n"
                    "• NOT recognised unless virtually certain; disclosed if probable\n\n"
                    "🔹 *IAS 37 Summary:*\n"
                    "Probable outflow → Provision (recognise) | Possible outflow → Disclose | Remote → Ignore\n"
                    "Virtually certain inflow → Asset (recognise) | Probable inflow → Disclose | Possible/Remote → Ignore"
                )
            },
            {
                "title": "Lec 8: Capital Structure of an LLC",
                "content": (
                    "🔹 *Incorporated vs Unincorporated:*\n"
                    "• LLC → limited liability; entity separate from owners; equity + debt finance; IFRS\n"
                    "• Sole trader/Partnership → unlimited liability; one capital account; drawings\n\n"
                    "🔹 *Equity Finance:*\n"
                    "• *Ordinary shares* — voting rights, residual interest, variable dividends\n"
                    "• *Irredeemable preference shares* — fixed dividends, priority over ordinary; classified as EQUITY\n\n"
                    "🔹 *Debt Finance:*\n"
                    "• *Redeemable preference shares, bonds, loan notes* — classified as LIABILITY\n"
                    "• Interest is tax-deductible; dividends are not\n\n"
                    "🔹 *Share issue accounting:*\n"
                    "• Issue price = Nominal value + Share premium\n"
                    "• DR Cash / CR Share Capital (nominal) + CR Share Premium (excess)\n\n"
                    "🔹 *Rights Issue* — new shares offered to existing shareholders at a discount → increases equity\n"
                    "• DR Cash | CR Share Capital + CR Share Premium\n\n"
                    "🔹 *Bonus Issue* — free shares to existing shareholders from share premium → NO change in equity\n"
                    "• DR Share Premium | CR Share Capital\n\n"
                    "🔹 *Share Repurchase* — DR Treasury Shares / CR Cash\n\n"
                    "🔹 *Dividends:*\n"
                    "• Ordinary & Irredeemable Preference: DR Retained Earnings / CR Cash (shown in SoCE)\n"
                    "• Redeemable Preference: DR Interest Expense / CR Cash (shown in SoPL)\n"
                    "• Proposed dividends → NOT a liability until declared/approved at AGM\n\n"
                    "🔹 *Internally-generated reserves:*\n"
                    "• Retained Earnings — distributable profits\n"
                    "• Revaluation Reserve & other OCI reserves — NOT distributable\n\n"
                    "🔹 *Statement of Changes in Equity (SoCE):*\n"
                    "Opening balance → Share issue/bonus → Total comprehensive income → Dividends → Closing balance"
                )
            },
            {
                "title": "Lec 9: Financial Statements of an LLC",
                "content": (
                    "🔹 *Period-end adjustments before reporting:*\n"
                    "Closing inventory (IAS 2) | Depreciation (IAS 16) | Revaluation |\n"
                    "Amortisation (IAS 38) | Accruals & prepayments | Bad debts (IFRS 9) |\n"
                    "Income tax (IAS 12) | Provisions (IAS 37) | Events after reporting period (IAS 10)\n\n"
                    "🔹 *Five financial statements (IFRS 18):*\n"
                    ...
                    "5. Statement of Cash Flows (IAS 7) + Notes\n\n"
                    "🔹 *SoPL — two presentation options (IFRS 18):*\n"
                    "• By *function* — expenses split by cost of sales, admin, selling\n"
                    "• By *nature* — expenses split by type (wages, depreciation, materials)\n\n"
                    "🔹 *OCI items (not in profit, go to reserves):*\n"
                    "Revaluation gains/losses | Pension plan gains/losses |\n"
                    "Foreign currency translation | Cash flow hedges | Fair value changes\n\n"
                    "🔹 *SoFP structure:*\n"
                    "Non-current assets (PPE, Intangibles) + Current assets (Inventory, Receivables, Cash)\n"
                    "= Equity (Share capital, Retained earnings, Reserves) + Non-current liabilities + Current liabilities\n\n"
                    "🔹 *Disclosure notes* — accounting policies, estimates, disaggregation of balances, risks\n\n"
                    "🔹 *Events After the Reporting Period (IAS 10):*\n"
                    "Events between year-end and date statements authorised for issue:\n"
                    "• *Adjusting events* — provide evidence of conditions EXISTING at reporting date → AMEND statements\n"
                    "  Examples: customer bankruptcy, inventory impairment confirmed, lawsuit settlement\n"
                    "• *Non-adjusting events* — conditions arising AFTER reporting date → DISCLOSE in notes\n"
                    "  Examples: fire, flood, new machinery purchase, division closure announced\n"
                    "• EXCEPTION: if going concern is affected → treat as adjusting regardless"
                )
            },
            {
                "title": "Lec 10: Statement of Cash Flows (IAS 7)",
                "content": (
                    "🔹 *Cash vs Profit:*\n"
                    "• Profit = accruals-based (revenue earned, expenses incurred)\n"
                    "• Cash flow = actual cash received and paid\n"
                    "• Differences arise from: accruals/prepayments, depreciation, revaluations, NCA transactions\n\n"
                    "🔹 *Cash & cash equivalents:*\n"
                    "• Cash on hand, bank deposits, short-term deposits (≤3 months maturity)\n"
                    "• Bank OVERDRAFT = current liability (deducted from cash)\n\n"
                    ...
                    "3. *Financing activities* — changes to equity capital and borrowings\n\n"
                    "🔹 *Indirect Method (Operating):*\n"
                    "Operating Profit\n"
                    "+ Depreciation/Amortisation/Impairment (add back)\n"
                    ...
                    "= Cash from operations before tax − Tax paid = Net cash from operations\n\n"
                    ...
                    "🔹 *IFRS 18 amendments to IAS 7:*\n"
                    "• Starts reconciliation from OPERATING PROFIT (not profit before tax)\n"
                    "• Interest & dividends PAID → financing activities\n"
                    "• Interest & dividends RECEIVED → investing activities\n\n"
                    "🔹 *Interpreting cash flows:*\n"
                    "• Positive CFO → healthy trading operations\n"
                    "• Negative CFI → investing in growth (buying assets)\n"
                    "• Positive CFF → new equity/debt raised; Negative CFF → repayments/dividends"
                )
            },
            {
                "title": "Lec 11: Interpretation of Financial Statements",
                "content": (
                    "🔹 *Financial ratio analysis* — used to compare performance across periods, companies, and industry benchmarks\n\n"
                    ...
                    "🔹 *Context matters:* High margins typical in Tech/Pharma; low in Retail/Manufacturing.\n"
                    "Low liquidity typical in Retail (fast inventory turnover); high in Manufacturing/Construction"
                )
            },
        ]
    },
